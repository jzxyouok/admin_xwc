...
class CHttp {
    ...
    static public  function curlProxy($url,$proxy){
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch,CURLOPT_PROXY,$proxy);//'10.151.85.42:10000'
//        curl_setopt($ch,CURLOPT_PROXYPORT,'8095');//'10.151.85.42:10000'
    ...
    static public function curlCve($url){
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt ($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 6.1; rv:19.0) Gecko/20100101 Firefox/19.0');
        curl_setopt($ch, CURLOPT_TIMEOUT, 20);
...
//        curl_setopt($ch, CURLOPT_PROXY, "120.26.238.36"); //代理服务器地址
...
//        curl_setopt($ch, CURLOPT_PROXYTYPE, CURLPROXY_HTTP); //使用http代理模式
    ...
    static public  function curlHttpProxy($url,$proxy){
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch,CURLOPT_PROXY,$proxy);//'10.151.85.42:10000'
    ...
    static public function curlJson($url,$sendJsonData){
        $ch = curl_init($url);
    ...
    static public function curlPost($url,$sendJsonData){
//        $ch = curl_init($url);
//        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
//        curl_setopt($ch, CURLOPT_POSTFIELDS, $sendJsonData);
//        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
//        return curl_exec($ch);
        ...
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
        curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($sendJsonData));
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 10);
        curl_setopt($ch, CURLOPT_TIMEOUT, 30);
        $result = curl_exec($ch);
    ...
    static public function curlSoap($url, $SoapRequest, $SoapAction) {
